        ...
        <div className="max-w-xl mb-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="px-3 py-2 bg-slate-50 border border-slate-300 rounded-xl font-mono text-sm font-bold text-slate-900 tracking-wider focus:outline-none focus:ring-1 focus:ring-amber-500 w-full"
            />
            <div className={`px-3 py-2 rounded-xl text-xs font-bold flex items-center gap-1 shrink-0 ${
              isGstinValid ? 'bg-emerald-100 text-emerald-900 border border-emerald-300' : 'bg-rose-100 text-rose-900 border border-rose-300'
            }`}>
              {isGstinValid ? <CheckCircle className="h-4 w-4 text-emerald-600" /> : <AlertCircle className="h-4 w-4 text-rose-600" />}
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-center font-mono">
              <div className="bg-white p-2 rounded border border-slate-200">
                <div className="text-base font-bold text-amber-700">{testGstin.substring(0, 2)}</div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs">
          ...
          <div className="space-y-2 text-xs text-slate-700">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex justify-between items-center">
              ...
              <span className="font-mono text-sm font-bold text-emerald-700">₹40 Lakhs</span>
            </div>
            ...
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex justify-between items-center">
              ...
              <span className="font-mono text-sm font-bold text-sky-700">₹20 Lakhs</span>
            </div>
            ...
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex justify-between items-center">
              ...
              <span className="font-mono text-sm font-bold text-rose-700">₹10 Lakhs</span>
            </div>
          ...
          <div className="space-y-3 text-xs text-slate-700">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="font-mono font-bold text-amber-700">Turnover &gt; ₹5 Crore</span>
              </div>
            ...
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="font-mono font-bold text-emerald-700">Value &gt; ₹50,000</span>
              </div>
              <p className="text-[11px] text-slate-600">
